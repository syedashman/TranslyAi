...
SPOKEN_TRANSLATION_SYSTEM_INSTRUCTION = (
    ...
    "DO NOT skip sentences, summarize content during translation, or omit secondary details. "
    "Keep all spoken points intact. The only words you may drop are the fillers and stutters removed in Step 1.\n"
